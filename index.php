  ...
  <article class="card extremes-card js-live-card" data-card-ok="<?= ($dayTemp['min'] !== null || $dayTemp['max'] !== null) ? '1' : '0' ?>">
    ...
    <div class="extremes-grid">
      <p class="extremes-line" title="<?= h($dayMinRefTooltip) ?>">
        ...
        <strong data-live-key="extremes_day_min" data-live-value="<?= h(isset($dayTemp['min']) && $dayTemp['min'] !== null ? (string) $dayTemp['min'] : '') ?>" title="<?= h($dayMinRefTooltip) ?>"><?= h($dayMinDisplay) ?> <small class="extremes-time">(<?= h(to_hhmm_from_db(isset($dayTempTimes['min_time']) ? (string) $dayTempTimes['min_time'] : null)) ?>)</small> <small class="extremes-ref-hint" aria-hidden="true">ⓘ</small></strong>
      </p>
      <p class="extremes-line" title="<?= h($dayMaxRefTooltip) ?>">
        ...
        <strong data-live-key="extremes_day_max" data-live-value="<?= h(isset($dayTemp['max']) && $dayTemp['max'] !== null ? (string) $dayTemp['max'] : '') ?>" title="<?= h($dayMaxRefTooltip) ?>"><?= h($dayMaxDisplay) ?> <small class="extremes-time">(<?= h(to_hhmm_from_db(isset($dayTempTimes['max_time']) ? (string) $dayTempTimes['max_time'] : null)) ?>)</small> <small class="extremes-ref-hint" aria-hidden="true">ⓘ</small></strong>
      </p>
