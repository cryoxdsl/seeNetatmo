...
$dayMinRefTooltip = t('extremes.historical_avg') . ' (' . $todayMonthDayLabel . '): ' . $dayMinRefDisplay;
$dayMaxRefTooltip = t('extremes.historical_avg') . ' (' . $todayMonthDayLabel . '): ' . $dayMaxRefDisplay;
...
if (!function_exists('alerts_type_icon_svg')) {
    ...
    {
        return match ($type) {
            'thunderstorm' => '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.2 13.8h11.2a3.1 3.1 0 0 0 .2-6.2 4.5 4.5 0 0 0-8.5-1.1A3.7 3.7 0 0 0 6.2 13.8z" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M12.8 10.2l-2.1 3.5h2l-1.2 3.9 3.9-5.5h-2.1l1-1.9z" fill="currentColor"/></svg>',
            'heavy_rain' => '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.2 12.8h11.2a3.1 3.1 0 0 0 .2-6.2 4.5 4.5 0 0 0-8.5-1.1A3.7 3.7 0 0 0 6.2 12.8z" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M8.6 15.1l-1 2.2M11.8 15.1l-1 2.2M15 15.1l-1 2.2" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M9.5 17.8l-.7 1.4M12.7 17.8l-.7 1.4M15.9 17.8l-.7 1.4" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" opacity=".75"/></svg>',
            'strong_wind' => '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.2 8.8h10.4c2.3 0 3.1-2.5 1.1-3.7M3.2 12.6h13.9c2.9 0 4 2.9 1.6 4.5M3.2 16.4h7.8c1.8 0 2.5-1.4 1.5-2.6" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><path d="M16.6 7.5l2 1.3-2 1.3" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'snow' => '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3.5v17M5.6 7.3l12.8 9.4M18.4 7.3L5.6 16.7" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M12 6.3l1.3.8M12 17l1.3.8M8.2 9.2l1.5 1.1M14.3 13.7l1.5 1.1M15.8 9.2l-1.5 1.1M9.7 13.7l-1.5 1.1" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg>',
            'heat' => '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="3.6" fill="none" stroke="currentColor" stroke-width="1.7"/><path d="M12 2.9v2.3M12 18.8v2.3M2.9 12h2.3M18.8 12h2.3M5.4 5.4l1.6 1.6M17 17l1.6 1.6M18.6 5.4L17 7M7 17l-1.6 1.6" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/><path d="M10.8 9.4c0 .9.6 1.4 1.2 1.9.8.7 1.4 1.3 1.4 2.7" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" opacity=".75"/></svg>',
            'frost' => '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3.5v17M6 7.5l12 9M18 7.5l-12 9" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><circle cx="12" cy="12" r="2.4" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M12 5.9l1 .6M12 17.5l1 .6M7.8 9l1 .8M15.2 13.6l1 .8M16.2 9l-1 .8M8.8 13.6l-1 .8" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" opacity=".75"/></svg>',
            default => '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4.2l1.8 3.6 4 .6-2.9 2.8.7 3.9-3.6-1.9-3.6 1.9.7-3.9-2.9-2.8 4-.6z" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/></svg>',
        };
    }
}
...
<section class="cards">
  ...
  <article class="card extremes-card js-live-card" data-card-ok="<?= ($dayTemp['min'] !== null || $dayTemp['max'] !== null) ? '1' : '0' ?>">
    ...
    <div class="extremes-grid">
      <p class="extremes-line" title="<?= h($dayMinRefTooltip) ?>">
      ...
      <p class="extremes-line" title="<?= h($dayMaxRefTooltip) ?>">
