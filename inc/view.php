...
function front_footer(): void
{
    ...
    echo '</main><footer class="foot"><div class="wrap">' . h($copyright) . ' | ' . h(t('footer.license')) . ' | ' . h(t('footer.contact')) . ': <a href="mailto:' . h(contact_email()) . '">' . h(contact_email()) . '</a> | <a href="/terms.php">' . h(t('footer.terms')) . '</a> | <a href="https://github.com/cryoxdsl/seeNetatmo" target="_blank" rel="noopener noreferrer">Git</a></div></footer>';
