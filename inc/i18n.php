...
function t(string $key): string
{
    static $dict = [
        'fr_FR' => [
            ...
            'alerts.zone' => 'Zone',
            'alerts.zone_station' => 'Zone de la station',
            'alerts.window' => 'Horizon',
            'alerts.window_official' => 'Bulletin officiel',
            'alerts.updated' => 'Analyse',
            'alerts.none' => 'Aucune alerte notable sur la période.',
            'alerts.unavailable' => 'Alertes indisponibles',
            'alerts.coords_required' => 'Définissez la latitude/longitude de la station dans l\'admin.',
            'alerts.retry_later' => 'Réessai en cours, rechargez la page dans quelques instants.',
            'alerts.hours_affected' => 'impactées',
            'alerts.period_from_to' => 'Du %s au %s',
            'alerts.period_from' => 'À partir du %s',
            'alerts.period_until' => 'Jusqu\'au %s',
            'alerts.period_updated' => 'Mise à jour : %s',
            'alerts.severity.low' => 'Jaune',
            'alerts.severity.moderate' => 'Orange',
            'alerts.severity.high' => 'Rouge',
            'alerts.type.thunderstorm' => 'Risque orageux',
            'alerts.type.heavy_rain' => 'Pluie forte',
            'alerts.type.strong_wind' => 'Vent fort',
            'alerts.type.snow' => 'Risque de neige',
            'alerts.type.heat' => 'Chaleur marquée',
            'alerts.type.frost' => 'Gel',
            'alerts.official_warning' => 'Alerte officielle',
            ...
            'site.alerts_zone_lat' => 'Latitude zone alertes (optionnel)',
            'site.alerts_zone_lon' => 'Longitude zone alertes (optionnel)',
            'site.alerts_zone_help' => 'Si renseignée, cette localisation est utilisée pour la card Alertes météo. Laisser vide pour utiliser la position station.',
            'site.alerts_source' => 'Source des alertes météo',
            'site.alerts_source_openmeteo' => 'Open-Meteo (dérivé du forecast)',
            'site.alerts_source_meteoalarm' => 'MeteoAlarm (bulletin officiel Europe)',
        ...
        'en_EN' => [
            ...
            'alerts.zone' => 'Zone',
            'alerts.zone_station' => 'Station area',
            'alerts.window' => 'Window',
            'alerts.window_official' => 'Official bulletin',
            'alerts.updated' => 'Analysis',
            'alerts.none' => 'No notable alert over this period.',
            'alerts.unavailable' => 'Alerts unavailable',
            'alerts.coords_required' => 'Set station latitude/longitude in admin settings.',
            'alerts.retry_later' => 'Retry in progress, refresh the page in a moment.',
            'alerts.hours_affected' => 'affected',
            'alerts.period_from_to' => 'From %s to %s',
            'alerts.period_from' => 'Starting %s',
            'alerts.period_until' => 'Until %s',
            'alerts.period_updated' => 'Updated: %s',
            'alerts.severity.low' => 'Yellow',
            'alerts.severity.moderate' => 'Orange',
            'alerts.severity.high' => 'Red',
            'alerts.type.thunderstorm' => 'Thunderstorm risk',
            'alerts.type.heavy_rain' => 'Heavy rain',
            'alerts.type.strong_wind' => 'Strong wind',
            'alerts.type.snow' => 'Snow risk',
            'alerts.type.heat' => 'Heat',
            'alerts.type.frost' => 'Frost',
            'alerts.official_warning' => 'Official warning',
            ...
            'site.alerts_zone_lat' => 'Alerts zone latitude (optional)',
            'site.alerts_zone_lon' => 'Alerts zone longitude (optional)',
            'site.alerts_zone_help' => 'If set, this location is used for the weather alerts card. Leave empty to use station coordinates.',
            'site.alerts_source' => 'Weather alerts source',
            'site.alerts_source_openmeteo' => 'Open-Meteo (derived from forecast)',
            'site.alerts_source_meteoalarm' => 'MeteoAlarm (official Europe bulletin)',
