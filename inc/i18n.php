...
function t(string $key): string
{
    static $dict = [
        'fr_FR' => [
            ...
            'footer.third_party' => 'Services tiers',
            'lang.fr' => 'FR',
            'lang.en' => 'EN',
            ...
            'weather.hero.local_only' => 'Affichage basé sur les mesures locales (indicateur station)',
            'weather.hero.source_forecast' => 'Prévision ciel',
            'weather.hero.local_indicator' => 'Indicateur station : %s',
            'weather.hero.local_humidity' => 'Humidité : %s%%',
            'weather.hero.station_age_min' => 'Mesure il y a %s min',
            ...
            'weather.detail.very_cloudy' => 'Humidité très élevée',
            'weather.label.cloudy' => 'Nuageux',
            'weather.detail.cloudy' => 'Humidité élevée',
            'weather.label.sunny' => 'Grand soleil',
            'weather.detail.sunny' => 'Air plutôt sec',
            'weather.label.voile' => 'Voile',
            'weather.detail.voile' => 'Conditions locales intermédiaires',
        ...
        'en_EN' => [
            ...
            'footer.third_party' => 'Third-party services',
            'lang.fr' => 'FR',
            'lang.en' => 'EN',
            ...
            'weather.hero.local_only' => 'Display based on local measurements (station indicator)',
            'weather.hero.source_forecast' => 'Sky forecast',
            'weather.hero.local_indicator' => 'Station indicator: %s',
            'weather.hero.local_humidity' => 'Humidity: %s%%',
            'weather.hero.station_age_min' => 'Measurement %s min ago',
            ...
            'weather.detail.very_cloudy' => 'Very high humidity',
            'weather.label.cloudy' => 'Cloudy',
            'weather.detail.cloudy' => 'High humidity',
            'weather.label.sunny' => 'Sunny',
            'weather.detail.sunny' => 'Dryer air',
            'weather.label.voile' => 'Partly cloudy',
            'weather.detail.voile' => 'Intermediate local conditions',
